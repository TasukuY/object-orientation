...
//Code here
let favoriteThings = {band: 'Radwimps', food: 'Ramen', person: 'My wife', book: 'One Piece', movie: 'LOTR', holiday: "New Year's day"};

/*
  After you've made your object, 
  use bracket or dot notation to add another key named 'car' with the value 
  being your favorite car and then another key named 'show' with the value being your favorite show.
*/

//Code here
favoriteThings.car = 'Tesla CyberTruck';
...
//Code Here
let phone1 = new Phone('Apple', 'iPhone13', 123, 'black', 500);
let phone2 = new Phone('Samsung', 'Galaxy S21', 456, 'gray', 700);
let phone3 = new Phone('Google', 'Pixel 5a', 789, 'white', 450);
...
//Code Here
let myFirstVehicle = new Vehicle(5, 'black', 1000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, 'gray', 5000, 'Honda', true);
...
//Code Here
let myFirstBoat = new Boat(10, 'white', 3000, 'Going Merry', 'yacht', false);
...
//Code Here
myFirstBoat.checkSwaworthiness();
/*
